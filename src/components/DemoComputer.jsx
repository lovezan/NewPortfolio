...
const DemoComputer = (props) => {
  ...
  // Flip the video texture vertically
  txt.wrapS = txt.wrapT = three.RepeatWrapping; // Allow texture transformations
  txt.repeat.y = -1; // Flip vertically
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          ...
          castShadow
          receiveShadow
          geometry={nodes["monitor-screen"].geometry} // Use the monitor screen geometry
          position={[0.127, 1.831, 0.511]} // Adjust position
          rotation={[1.571, -0.005, 0.031]} // Adjust rotation
          scale={[0.661, 0.608, 0.401]} // Adjust scale
        >
          {/* Apply video texture to the monitor screen */}
